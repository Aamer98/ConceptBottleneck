...
def run_epoch(model, optimizer, loader, loss_meter, acc_meter, criterion, attr_criterion, args, is_training batch_time, 
                                                            data_time, losses_m, top1, middle1_losses, middle2_losses, middle3_losses, losses1_kd, losses2_kd, losses3_kd, 
                                                            feature_losses_1, feature_losses_2, feature_losses_3, total_losses, middle1_top1, middle2_top1, middle3_top1):
    """
...
def train(model, args):
    ...
    logger.flush()
    model = models.__dict__['multi_resnet18_kd'](num_classes=3).cuda()
    #model = model.cuda()
    ...
    for epoch in range(0, args.epochs):
        ...
        if args.no_img:
            ...
            train_loss_meter, train_acc_meter = run_epoch(model, optimizer, train_loader, train_loss_meter, train_acc_meter, criterion, attr_criterion, args, is_training=True, batch_time, 
